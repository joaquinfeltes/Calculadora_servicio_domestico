const CONSTANTS = {
  ...
  FEBRERO_2024: {
    ...
    SEPTIEMBRE_2024: {
      MENSUAL_RETIRO: [0,  406849.5, 377985.5, 368785.5, 331644.6],
      MENSUAL_CAMA_ADENTRO: [0, 453183.5, 420762, 368785.5, 410972.5, 368785.5],
      POR_HORA_RETIRO: [0, 3261.12, 3088, 2916.5, 2704],
      POR_HORA_CAMA_ADENTRO: [0, 3572, 3385, 2916.5, 3261, 2916.5],
    },
    OCTUBRE_2024: {
        MENSUAL_RETIRO: [0,  418241.5, 388569, 379111.5, 340930.6],
        MENSUAL_CAMA_ADENTRO: [0, 465872.5, 432543.5, 379111.5, 422480, 379111.5],
        POR_HORA_RETIRO: [0, 3352.5, 3174.5, 2998.5, 2780],
        POR_HORA_CAMA_ADENTRO: [0, 3672, 3480, 2998.5, 3352.5, 2998.5],
      },
};
