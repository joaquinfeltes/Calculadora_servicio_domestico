...
DICIEMBRE_2023: {
  ...
  FEBRERO_2024: {
    ...
    ABRIL_2024: {
      ...
      POR_HORA_CAMA_ADENTRO: [0, 2867.5, 2717, 2341, 2617.5, 2341],
    },
    MAYO_2024: {
      MENSUAL_RETIRO: [0,  349374, 324588.5, 316688, 284794.5],
      MENSUAL_CAMA_ADENTRO: [0, 389163, 361322.5, 316688, 352916, 316688],
      POR_HORA_RETIRO: [0, 2801, 2652, 2505, 2322],
      POR_HORA_CAMA_ADENTRO: [0, 3068, 2907, 2505, 2801, 2505],
    },
};
