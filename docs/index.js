...
const CONSTANTS = {
  ...
  ABRIL_2023: {
    MENSUAL_RETIRO: [0,  104993, 97544, 95170, 85585.5],
    MENSUAL_CAMA_ADENTRO: [0, 116950.5, 108583.5, 95170, 106057, 95170],
    POR_HORA_RETIRO: [0, 841.5, 796.5, 752, 697],
    POR_HORA_CAMA_ADENTRO: [0, 921, 873.5, 752, 841.5, 752],
  },
  MAYO_2023: {
    MENSUAL_RETIRO: [0,  111440, 103534, 101014, 90841],
    MENSUAL_CAMA_ADENTRO: [0, 124132, 115251, 101014, 12569.5, 101014],
    POR_HORA_RETIRO: [0, 893, 845.5, 798, 740],
    POR_HORA_CAMA_ADENTRO: [0, 978, 927, 798, 893, 798],
  },
  JUNIO_2023: {
    MENSUAL_RETIRO: [0,  116966, 108667.5, 106023, 95345.5],
    MENSUAL_CAMA_ADENTRO: [0, 130287, 120965.6, 106023, 118151.5, 106023],
    POR_HORA_RETIRO: [0, 937.5, 887, 837.5, 776.5],
    POR_HORA_CAMA_ADENTRO: [0, 1026.5, 973, 837.5, 937.5, 837.5],
  }
};
