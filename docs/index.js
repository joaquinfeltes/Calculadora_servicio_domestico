const CONSTANTS = {
  ...
  DICIEMBRE_2022: {
    MENSUAL_RETIRO: [0, 80215, 74524.5, 72710.5, 65387.5],
    MENSUAL_CAMA_ADENTRO: [0, 89350.5, 82958, 72710.5, 81028, 72710.5],
    POR_HORA_RETIRO: [0, 643, 608, 574, 532.5],
    POR_HORA_CAMA_ADENTRO: [0, 704, 667, 574, 643, 574],
  },
};
