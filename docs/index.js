const CONSTANTS = {
  ...
  FEBRERO_2024: {
    ...
    SEPTIEMBRE_2024: {
      MENSUAL_RETIRO: [0,  406848, 377985, 368785, 331644],
      MENSUAL_CAMA_ADENTRO: [0, 453183, 420761, 368785, 410972, 368785],
      POR_HORA_RETIRO: [0, 3260, 3086, 2915, 2704],
      POR_HORA_CAMA_ADENTRO: [0, 3570, 3384, 2915, 3260, 2915],
    },
    OCTUBRE_2024: {
      MENSUAL_RETIRO: [0,  418240, 388569, 379111, 340930],
      MENSUAL_CAMA_ADENTRO: [0, 465872, 432543, 379111, 422479, 379111],
      POR_HORA_RETIRO: [0, 3351, 3173, 2997, 2779],
      POR_HORA_CAMA_ADENTRO: [0, 3670, 3479, 2997, 3351, 2997],
    },
    NOVIEMBRE_2024: {
      MENSUAL_RETIRO: [0,  418240, 388569, 379111, 340930],
      MENSUAL_CAMA_ADENTRO: [0, 465872, 432543, 379111, 422479, 379111],
    ...
    DICIEMBRE_2024: {
      MENSUAL_RETIRO: [0,  423677, 393620, 384039, 345362],
      MENSUAL_CAMA_ADENTRO: [0, 471928, 438166, 384039, 427971, 384039],
      POR_HORA_RETIRO: [0, 3395, 3214, 3036, 2815],
      POR_HORA_CAMA_ADENTRO: [0, 3718, 3524, 3036, 3395, 3036],
    },
    ENERO_2025: {
      MENSUAL_RETIRO: [0,  428761, 398344, 388648, 349506],
      MENSUAL_CAMA_ADENTRO: [0, 477591, 432543, 388648, 433107, 388648],
      POR_HORA_RETIRO: [0, 3435, 3253, 3072, 2849],
      POR_HORA_CAMA_ADENTRO: [0, 3762, 3567, 3072, 3435, 3072],
    },  
};
